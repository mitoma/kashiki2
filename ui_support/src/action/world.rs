...
fn remove_current(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn reset_zoom(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.look_current(CameraAdjustment::FitBoth);
}

world_processor!(WorldLookCurrent, "look-current", look_current);
fn look_current(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn swap_next(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.swap_next();
}

world_processor!(WorldSwapPrev, "swap-prev", swap_prev);
fn swap_prev(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.swap_prev();
}

world_processor!(WorldFitWidth, "fit-width", fit_width);
fn fit_width(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.look_current(CameraAdjustment::FitWidth);
}

world_processor!(WorldFitHeight, "fit-height", fit_height);
fn fit_height(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.look_current(CameraAdjustment::FitHeight);
}

world_processor!(WorldFitByDirection, "fit-by-direction", fit_by_direction);
fn fit_by_direction(_arg: &ActionArgument, context: &UiContext, world: &mut dyn World) {
...
fn forward(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.camera_operation(CameraOperation::Forward);
}

world_processor!(WorldBack, "back", back);
fn back(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.camera_operation(CameraOperation::Backward);
}

world_processor!(WorldChangeDirection, "change-direction", change_direction);
fn change_direction(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn increase_row_interval(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn decrease_row_interval(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn increase_col_interval(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn decrease_col_interval(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn increase_col_scale(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn decrease_col_scale(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn increase_row_scale(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn decrease_row_scale(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn toggle_min_bound(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn toggle_psychedelic(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.model_operation(&ModelOperation::TogglePsychedelic);
}

world_processor!(WorldMoveToClick, "move-to-click", move_to_click);
fn move_to_click(arg: &ActionArgument, context: &UiContext, world: &mut dyn World) {
    match arg {
...
fn move_to_click_with_mark(arg: &ActionArgument, context: &UiContext, world: &mut dyn World) {
    match arg {
        ActionArgument::Point((x, y)) => {
            let (x_ratio, y_ratio) = (
                (x / context.window_size().width as f32 * 2.0) - 1.0,
...
fn change_layout(arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    match arg {
...
fn set_model_border(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn unset_model_border(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn change_max_col_ui(_arg: &ActionArgument, context: &UiContext, world: &mut dyn World) {
    log::info!("fooo");
...
fn change_max_col(arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
...
fn increase_max_col(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
    world.model_operation(&ModelOperation::IncreaseMaxCol);
}

world_processor!(WorldDecreaseMaxCol, "decrease-max-col", decrease_max_col);
fn decrease_max_col(_arg: &ActionArgument, _context: &UiContext, world: &mut dyn World) {
