    ...
    pub fn random_motion() -> MotionFlags {
        ...
        (0..4).for_each(|_| {
            motion_target |= match rng.random_range(0..=15) {
                ...
                7 => MotionTarget::ROTATE_X_MINUS,
                8 => MotionTarget::ROTATE_Y_PLUS,
                9 => MotionTarget::ROTATE_Y_MINUS,
                10 => MotionTarget::ROTATE_Z_PLUS,
                11 => MotionTarget::ROTATE_Z_MINUS,
...
bitflags! {
    pub struct MotionTarget: u16 {
        ...
        const ROTATE_X_MINUS  = 0b_0000_0000_1000_0000;
        const ROTATE_Y_PLUS   = 0b_0000_0001_0000_0000;
        const ROTATE_Y_MINUS  = 0b_0000_0010_0000_0000;
        const ROTATE_Z_PLUS   = 0b_0000_0100_0000_0000;
        const ROTATE_Z_MINUS  = 0b_0000_1000_0000_0000;
