...
impl KeyCode {
    pub fn from(from: winit::event::VirtualKeyCode) -> Self {
        match from {
...
impl ModifiersState {
    pub fn from(from: winit::event::ModifiersState) -> Self {
        let on_ctrl = from.contains(winit::event::ModifiersState::CTRL);
        let on_alt = from.contains(winit::event::ModifiersState::ALT);
        let on_shift = from.contains(winit::event::ModifiersState::SHIFT);
